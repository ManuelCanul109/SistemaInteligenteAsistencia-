...
public class ScannerBarcodeActivity extends AppCompatActivity {
    ...
    private void initialiseDetectorsAndSources() {
       // Toast.makeText(getApplicationContext(), "Escáner de código de barras iniciado", Toast.LENGTH_SHORT).show();
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
                // Toast.makeText(getApplicationContext(), "Para evitar pérdidas de memoria, se ha detenido el escáner de código de barras", Toast.LENGTH_SHORT).show();
            }
